...
import { useCreateNewProductMutation } from "@/redux/query/productApi";
...
const ProductForm: React.FC = () => {
  ...
  const [
    createNewProduct,
    { isLoading: isCreateNewProductLoading, isError: isCreateNewProductError },
  ...
  const [formData, setFormData] = useState<FormData>({
    title: "",
    description: "",
    variants: [{ sku: "", price: "", stock: 0, variantOptions: [] }],
